...
# personal job satisfaction construct
pjs_items <- c(
  result$d_meaningful_work,
  result$d_recommend_agency,
  result$d_use_job_skills
)

# professional growth opportunities construct
pgo_items <- c(
  result$d_take_new_roles,
  result$d_take_high_tech_resp,
  result$d_take_super_resp
)

# agency satisfaction
as_items <- c(
  result$d_unit_high_qual_prod,
  result$d_use_wf_eff,
  result$d_retain_best
)
